      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 static  w-full z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
          ...
          <div className="flex md:order-2">
            <button
              type="button"
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-[#2499ED] dark:hover:bg-blue-700 dark:focus:ring-blue-300 flex max-[500px]:hidden"
            >
              <svg
